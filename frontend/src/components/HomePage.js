...
function HomePage({ totalWorkouts, totalMeals, onAddActivity }) {
        ...
        <div className="main-dashboard-content">
            <div className="dashboard-header">
                ...
                <div className="user-profile">
                    <span className="user-greeting">Hello, Jane Doe</span>
                    <div className="user-avatar">
                        <img src="https://placehold.co/100x100/DC2626/ffffff?text=JD" alt="User Profile" />
                    </div>
                </div>
            </div>
